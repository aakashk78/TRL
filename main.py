...
with tab2:
    ...
    st.write(
        'Link to [Excel file](https://github.com/aakashk78/TRL/blob/master/Final%20Compendium.xlsx)')

with tab3:
    st.header('Summary of Technology Readiness Levels')
    st.write('Link to [Tableau Dashboard](https://public.tableau.com/views/TRLSummary/Dashboard1?:language=en-US&publish=yes&:display_count=n&:origin=viz_share_link)')
    def main():
        ...
        components.html(html_temp, width=1100, height=900)
